...
async function getBanks() {
  let response = await axios.get(
    "https://api.paystack.co:443/bank?country=nigeria",
    {
      headers: {
        Authorization:
          "Bearer sk_test_9684e8c5e16ebdf4816bbfaac0c28086971cb6ca",
      },
    }
  );
  ...
  return (
    <div>
      ...
      <Button
        ...
        onClick={() => {
          CUSTOM_API.userAPI
            ?.postInstructorBankAccount({
              account_number: accountNum,
              primary_contact_email: email,
              primary_contact_phone: phone,
              settlement_bank: settlementBank,
              primary_contact_name: accountNum,
